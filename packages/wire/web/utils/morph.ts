...
export function resolveMorphKey(node: Element | null | undefined): string | null {
    ...
    const wireModelAttrs = node.getAttributeNames().filter((name) => name.startsWith("wire:model"));
