    ...
    public async call(componentId: string, method: string, params: any[] = []) {
        ...
        return new Promise((resolve, reject) => {
            const timeout = setTimeout(() => {
                ...
                reject(new Error(`Socket request timed out after ${this.options.requestTimeoutMs}ms.`));
            ...
            reject(new Error("Socket transport is enabled but no websocket connection is available."));
        });
    }
