...
function injectStyles() {
    ...
    #nprogress .peg {
      ...
      box-shadow: 0 0 10px var(--kirewire-progress-bar-color, #29d), 0 0 5px var(--kirewire-progress-bar-color, #29d);
      opacity: 1.0;
    ...
    #nprogress .spinner-icon {
      ...
      border-top-color: var(--kirewire-progress-bar-color, #29d);
      border-left-color: var(--kirewire-progress-bar-color, #29d);
      border-radius: 50%;
