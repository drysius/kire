export function toggleBooleanState(el: HTMLElement, directive: any, isTruthy: boolean, cachedDisplay: string | null = null) {
...
export function extractDuration(modifiers: string[], defaultDuration = 2000): number {
