...
export const wildcardHandler = (el: HTMLElement, dir: Directive, component: Component) => {
    // block reserved directives that are not events
    const reserved = ['model', 'init', 'loading', 'poll', 'ignore', 'id', 'data', 'key', 'target', 'dirty', 'snapshot', 'effects'];
