...
import { initKireLogChannel, kireLog, refreshKireLogConfig, showKireLogs } from "./core/log";
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const jsWatcher = vscode.workspace.createFileSystemWatcher("**/kire.schema.js");
	...
	context.subscriptions.push(
        ...
        vscode.workspace.onDidChangeConfiguration((event) => {
            ...
            if (event.affectsConfiguration("kire.schema.scanNodeModules")) {
                kireLog("info", "kire.schema.scanNodeModules changed; reloading schemas.");
                void loadSchemas();
            }
        }),
	);
